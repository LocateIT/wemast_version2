<template>
    <div class="aselect" :data-value="placeholder" :data-list="list">
      <div class="selector" @click="toggle()">
          <div class="label">
                  <span>{{ storeUserSelections.season_placeholder }}</span>
          </div>
          ...
          <div :class="{ hidden : !visible, visible }">
              <ul>
                  ...
                  <li :class="{ current : item === storeUserSelections.season_placeholder }" 
                  v-for="item in storeUserSelections.season_list" :key="item"
                  @click="storeUserSelections.showSelectedSeason(item)">{{ item }}</li>
  ...
  const storeUserSelections = useCounterStore()
        ...
        //   console.log(list, 'regions list')
          ...
          const toggle = () => {
              ...
              storeUserSelections.fetchSeasonsList()
          }
          const select = (option) =>{
