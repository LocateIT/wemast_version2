...
<template>
    <div class="aselect" :data-value="placeholder" :data-list="list">
      <div class="selector" @click="toggle()">
          <div class="label">
                  <span>{{ advancedFilterSelections.platform_placeholder}}</span>
          </div>
          ...
          <div :class="{ hidden : !visible, visible }">
              <ul>
                  ...
                  <li :class="{ current : item === platform_placeholder }"
                   v-for="item in  advancedFilterSelections.platform_list" :key="item" 
                   @click=" advancedFilterSelections.showSelectedPlatform(item)">{{ item }}</li>
