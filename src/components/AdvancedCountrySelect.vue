<template>
    <div class="aselect" :data-value="placeholder" :data-list="list">
      <div class="selector" @click="toggle()">
          <div class="label">
                  <span>{{ advancedFilterSelections.country_placeholder}}</span>
          </div>
          ...
          <div :class="{ hidden : !visible, visible }">
              <ul>
                  ...
                  <li :class="{ current : item === country_placeholder }"
                   v-for="item in  advancedFilterSelections.country_list" :key="item" 
                   @click=" advancedFilterSelections.showSelectedCountry(item)">{{ item }}</li>
        ...
        //   console.log(list, 'regions list')
          ...
          const toggle = () => {
              visible.value = !visible.value;
               ...
               advancedFilterSelections.fetchCountriesList()
          }
          const select = (option) =>{
